                            ...
                            >
                                <div class="flex justify-between items-center">
                                    <p class="text-[16px] font-medium">
                                        ...
                                        <!-- new field start-->
                                        <span v-if="address.demo">(@{{ address.demo }})</span>
                                         <!-- new field end -->
            ...
            <x-slot:content>
                ...
                >
                    <form @submit="handleSubmit($event, handleBillingAddressForm)">
                        ...
                        <x-shop::form.control-group>
                            <x-shop::form.control-group.label>
                                @lang('shop::app.checkout.onepage.addresses.billing.demo-name')
                            </x-shop::form.control-group.label>
                
                            <x-shop::form.control-group.control
                                type="text"
                                name="billing[demo]"
                                :label="trans('shop::app.checkout.onepage.addresses.billing.demo-name')"
                                :placeholder="trans('shop::app.checkout.onepage.addresses.billing.demo-name')"
                                v-model="forms.billing.address.demo"
                            >
                            </x-shop::form.control-group.control>
    
                            <x-shop::form.control-group.error
                                control-name="billing[demo]"
                            >
                            </x-shop::form.control-group.error>
                        </x-shop::form.control-group>

                            {!! view_render_event('bagisto.shop.checkout.onepage.billing_address.demo.after') !!}
